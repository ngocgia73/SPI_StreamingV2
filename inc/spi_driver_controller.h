...
#define CONFIG_FTSPI010_USE_AHBDMA  1 //GM8283  CONFIG_FTSPI020_USE_AHBDMA ..GM8210 CONFIG_FTSPI020_USE_AXIDMA
...
#define FTSPI010_DMA_BUF_SIZE   (512 * 1024) // VinhPQ: CV2055 only use DMA 512KB
#endif
...
static void ftspi010_dma_callback(void *param);
static unsigned int trigger_flag = 0;
static wait_queue_head_t spi010_queue;
